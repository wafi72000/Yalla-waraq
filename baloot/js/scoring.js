// scoring.js — حساب اليد الكامل: نقاط الورق + المشاريع + الكبوت + الخسران + الدبل
//
...
export function scoreHand({
  ...
  // ===== كبوت: يستبدل كل الحساب - نقاط ثابتة + مشاريع الفريق نفسه (مضروبة بمضاعف النظام)، مضروبة بمعامل الدبل =====
  if (capotTeam) {
